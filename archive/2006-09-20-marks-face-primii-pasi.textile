...
Fata de planul "initial":http://www.locknet.ro/article/marks-my-rails-pet-project, am ales sa fac @modelul@ bookmark cu 
...
Pentru taguri, am folosit pluginul "Act As Taggable":http://wiki.rubyonrails.org/rails/pages/Acts+As+Taggable+Plugin cu destule "modificari":http://dema.ruby.com.br/articles/2005/09/03/tagging-on-steroids-with-rails ce permit gruparea acestora per user.
