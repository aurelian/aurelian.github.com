...
"Anuntam":http://www.locknet.ro/article/marks-my-rails-pet-project acum cateva zile intentia de a dezvolta primul meu proiect public in "rails":http://www.rubyonrails.com.
...
<div class="mta"><a href="http://assets.locknet.ro/images/16.png" rel="lightbox" title="Marks Code Fixing">

!http://assets.locknet.ro/images/16t.png(Marks Code Fixing)!
...
Ce a iesit pana acum se poate vedea "aici":http://marks.29dots.com/account.
...
Pentru a fii sigur ca nimeni nu va folosi numele tau de utilizator preferat rezerva-ti un cont chiar "acum":http://marks.29dots.com/account/create :)
