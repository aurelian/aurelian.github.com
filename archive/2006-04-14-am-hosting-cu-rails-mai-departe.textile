...
Inapoi la consola, mi-am compilat si ruby, versiunea 1.8.4, tot ca utilizator obisnuit, si am scris repede un mic "HelloWorld(Hello world program)":http://en.wikipedia.org/wiki/HelloWorld de "test(Hello Ruby World)":http://29dots.com/hw.cgi.
