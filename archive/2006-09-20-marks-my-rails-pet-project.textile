...
Marks vine de la Book<b>marks</b> si, TADA: va fi o clona dupa "del.icio.us":http://del.icio.us.

Asa "cum":http://www.locknet.ro/article/rails-primele-3-indicii "ziceam":http://www.locknet.ro/article/am-hosting-cu-rails-mai-departe, este doar un pet project, nu caut celebritatea in domeniul asta, si nici nu incerc sa intru pe piata celor care ofera "Social Bookmarks" (din unele statistici, cica ar fi peste 20 de astfel de aplicatii).
...
Pentru taguri va fi folosit pluginul "Acts As Taggable":http://wiki.rubyonrails.org/rails/pages/Acts+As+Taggable+Plugin
...
Poti vedea cum progreseaza PLANUL pe "http://marks.locknet.ro":http://marks.locknet.ro. O sa anunt cand va fi gata pentru testare.
